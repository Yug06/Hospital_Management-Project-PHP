...
if (isset($_GET['del_id'])) {
    $id = $_GET['del_id'];
    $sql = "update `tbl_testimonial` set `status`='1' WHERE `id`='$id'";
    $result = mysqli_query($con, $sql);
    if ($result) {
        $success = "Review Visible";
    } else {
                            ...
                            <div class="card-box">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        ...
                                        <?php
                                        $sql1 = "SELECT * FROM `tbl_testimonial`";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="testimonial.php?del_id=<?php echo $data['id']; ?>" class="badge badge-success"><i class="mdi mdi-check"></i> Active</a>
