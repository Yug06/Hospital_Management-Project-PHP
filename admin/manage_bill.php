...
if(isset($_GET['delid']))
  {
    $delid = $_GET['delid'];
    $sql = "DELETE FROM `tbl_invoice` WHERE `invoiceid`='$delid'";
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> <?php
                                                        ...
                                                        ?></td>
  <td>
                                                        <a href="manage_bill.php?delid=<?php echo $data['invoiceid'];?>" class="badge badge-danger"><i class="fas fa-trash"></i> Delete</a>
                                                        <a href="update_bill.php?pid=<?php echo $data['patientid'] ?>&&inid=<?php echo $data['invoiceid']?>" class="badge badge-success"><i class="fas fa-edit "></i>Update Payroll</a>
