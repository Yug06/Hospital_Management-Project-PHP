                            ...
                            <div class="row">
                                    ...
                                    <div class="card-box text-center" style="width: 100%; display: flex; justify-content: space-between;">
                                        <div class="image">
                                            ...
                                            <img src="../doctor/assets/images/users/<?php echo $row['picture']; ?>" class="avatar-lg img-fluid" alt="profile-image" style="height: 55%; width: 65%; border-radius: 6px; margin-top: 80px; margin-left: 100px;">
                                        </div>
                                        

                                        <div class="text-centre mt-5" style="margin-right: 200px; text-align: center;">
                                            <p class="mb-2 font-20"><strong>Id :</strong> <span class="ml-2"><?php echo $doc_id; ?></span></p>
                                            ...
                                            <p class="mb-2 font-20"><strong>Degree :</strong> <span class="ml-2"><?php echo $row['degree']; ?></span></p>
                                            <p class="mb-2 font-20"><strong>Department :</strong> <span class="ml-2">
                                                    <?php
