...
{    
    ...
    $f_dir='../slideshow/'.$f_name;
    move_uploaded_file($_FILES['picture']['tmp_name'],$f_dir);

    $sql = "INSERT INTO `tbl_slideshow`(`picture`) VALUES ('$f_name')";
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        ...
                                        $sql1 = "SELECT * FROM tbl_slideshow";
                                        ...
                                        ?>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><?php echo $cnt; ?></td>   
                                                    <td> <center><img src="../slideshow/<?php echo $data['picture']; ?>" alt="picture" style  width="200px" height="150px"></center></td>

                                                    <td>  <a href="slideshow.php?del_id=<?php echo $data['id']; ?>" class="badge badge-danger"><i class=" mdi mdi-trash-can-outline "></i> Delete</a></td>
                                                </tr>
                                            </tbody>
                                        <?php $cnt = $cnt + 1;
                                        } ?>
