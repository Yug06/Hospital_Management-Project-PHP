                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">#<?php echo $prid; ?></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                        ...
                                        <div class="col-xl-7">
                                            <div class="pl-xl-3 mt-3 mt-xl-0">
                                                <h2 class="mb-3">Name : <?php
                                                    ...
                                                    ?></h2>
                                                     <h2 class="mb-3">Prescribed by : <?php
                                                    ...
                                                    ?></h2>
                                                <hr>
                                                <h3 class="text-danger ">Patient Category :    <?php
                                                        ...
                                                        <?php
                                                         ...
                                                         ?></h3>
                                                <hr>
                                                <h3 class="text-danger">Disease : <?php echo $disease; ?></h3>
                                                <hr>
