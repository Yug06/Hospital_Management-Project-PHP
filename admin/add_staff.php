...
if(isset($_POST['add_emp']))
{
    ...
    $sql = "INSERT INTO `tbl_staff`(`name`,`lname`, `email`, `password`, `address`, `phone`, `picture`, `stid`) VALUES ('$name','$lname','$email','$password','$address','$phone','$f_name','$designation')";
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select id="inputState" required="required" name="stid" class="form-control">
                                                    <optgroup label="select category">
                                                        
                                                        <?php

                                                        $sql1 = "select * from tbl_staff_type";
                                        ...
                                        <button type="submit" name="add_emp" class="ladda-button btn btn-success" data-style="expand-right">Add Employee</button>
