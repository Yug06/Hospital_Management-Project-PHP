                            ...
                            <div class="card-box">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        ...
                                        <?php
                                        $sql1 = "SELECT * FROM `tbl_appointment` where doctorid='$did' and status='1'";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="add_single_prescription.php?pr_id=<?php echo $data['doctorid'];?>" class="badge badge-warning"><i class="fas fa-highlighter"></i>Add Prescription</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                        <tfoot>
