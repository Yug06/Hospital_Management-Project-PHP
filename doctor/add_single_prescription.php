...
if (isset($_GET['pr_id'])) {
    ...
    $sql = "SELECT * FROM `tbl_appointment` WHERE `doctorid`='$did'";
...
{   
    ...
    $sql = "INSERT INTO `tbl_prescription`(`doctorid`, `patientid`, `disease`, `description`, `date`) VALUES ('$doctorid','$patientid','$disease','$pres',NOW())";
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="patientid" class="col-form-label">First Name</label>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="patientid" class="col-form-label">Last Name</label>
                                                <input disabled type="text" name="patid" class="form-control" id="patid" value=<?php 
                                                $sql = "select * from tbl_patient where patientid=$patientid";
                                                $result = mysqli_query($con, $sql);
                                                if($result){
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required="required" type="text" name="disease" class="form-control" id="disease">
                                        </div>

                                        <div class="form-group">
                                                        <label for="inputAddress" class="col-form-label">Prescription</label>
                                                        <textarea required="required"  type="text" class="form-control" name="pres" id="editor"></textarea>
                                                </div>

                                        <button type="submit" name="add_pre" class="ladda-button btn btn-success" data-style="expand-right">Add Prescription</button>
