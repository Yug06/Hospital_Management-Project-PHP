                            ...
                            <div class="card-box">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        ...
                                        $sql1 = "select p.patientid,p.name,p.lname,i.date,p.ptid,i.invoiceid from tbl_patient p, tbl_invoice i where p.patientid = i.patientid and p.patientid='$pid'";
                                        ...
                                        ?>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><a href="generate_individual_bill.php?pid=<?php echo $pid ?>&&inid=<?php echo $data['invoiceid']?>" class="badge badge-success"><i class="mdi mdi-beaker "></i>Get Bill</a></td>
                                                </tr>
                                            </tbody>
                                        <?php $cnt = $cnt + 1;
                                        } ?>
