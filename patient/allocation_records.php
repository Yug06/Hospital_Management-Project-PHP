                            ...
                            <div class="card-box">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        ...
                                        <?php
                                        $sql1 = "SELECT t.bdid,t.bedid,t.patientid,t.allotmentTime,t.dischargementTime,b.status FROM tbl_bed_allocation t,tbl_bed b,tbl_patient p where b.bedid=t.bedid and p.patientid=t.patientid and t.patientid='$pid'";
