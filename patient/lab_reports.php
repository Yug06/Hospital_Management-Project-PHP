                            ...
                            <div class="card-box">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        ...
                                        $sql1 = "SELECT p.patientid,p.ptid,p.name,p.lname,l.lid FROM tbl_patient p,tbl_labreport l where p.patientid=l.patientid and p.patientid='$pid'";
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php
                                                        ...
                                                        $sql1 = "select disease from tbl_prescription where `patientid`='$pid'";
                                                    ...
                                                    <td><a href="view_single_labreport.php?pid=<?php echo $pid ?>&&lid=<?php echo $lid;?>" class="badge badge-success"><i class="mdi mdi-eye "></i> View Lab Report</a></td>
                                                </tr>
                                            </tbody>
                                        <?php $cnt = $cnt + 1;
                                        } ?>
