...
<body>
  ...
  <section id="dep" class="departments">
...
if ($res) {
    ...
    foreach ($departments as $index => $department) {
        ...
        echo '<div class="tab-pane ' . $isActive . '" id="tab-' . ($index + 1) . '">';
        if ($isActive) {
            echo '<h3>' . $department['name'] . '</h3>
                  <p class="fst-italic">' . $department['heading'] . '</p>
                  <img src="department/' . $department['picture'] . '" alt="" class="img-fluid">
