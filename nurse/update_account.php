<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_profile']))
		{
            ...
            $sql = "UPDATE `tbl_staff` SET `name`='$name',`lname`='$lname',`email`='$email',`address`='$address',`phone`='$phone',`picture`='$f_name' WHERE `sid`='$id'";
        ...
        if(isset($_POST['update_pwd']))
		{
			...
			$query="UPDATE tbl_staff SET password =? WHERE sid = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('si', $pwd, $id);
			$stmt->execute();
			/*
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    <img src="../staff/<?php echo $row['picture'];?>" class="rounded-circle avatar-lg img-thumbnail"
                                        alt="profile-image">

                                    
                                    <div class="text-centre mt-3">
                                        
                                           <p class="mb-2 font-15"><strong>Id :</strong> <span class="ml-2"><?php echo $sid; ?></span></p>
                                            ...
                                            <p class="mb-2 font-15"><strong>Designation :</strong> <span class="ml-2">
                                                    <?php
